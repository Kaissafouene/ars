...
export declare class DashboardController {
    ...
    getOverview(query: any, req: any): Promise<{
        traitementKpi: {
            total: number;
            traite: number;
            enDifficulte: number;
    ...
    getAlertsSummary(query: any, req: any): Promise<{
    ...
    exportKpis(query: any, req: any, res: Response): Promise<void>;
    syncBs(): Promise<{
        lastSync: any;
        imported: any;
        errors: any;
    ...
    getAdvancedKpis(query: any, req: any): Promise<{
        planned: {
