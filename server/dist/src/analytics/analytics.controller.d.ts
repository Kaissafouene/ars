...
export declare class AnalyticsController {
    ...
    getSlaComplianceByUser(query: any, req: any): Promise<{
        userId: any;
        total: any;
        slaCompliant: any;
        complianceRate: number;
    }[]>;
    getReclamationPerformance(query: any, req: any): Promise<any[]>;
    getClientDashboard(query: any, req: any): Promise<{
        clientId: any;
        volume: number;
        slaCompliant: number;
        slaBreaches: number;
    ...
    getUserDailyTargetAnalysis(query: any, req: any): Promise<{
        userId: any;
        avgPerDay: number;
        target: any;
        meetsTarget: boolean;
    }[]>;
    getPriorityScoring(query: any, req: any): Promise<{
    ...
    getComparativeAnalysis(query: any, req: any): Promise<{
        period1: {
            total: number;
            sla: number;
        };
    ...
    getSlaTrend(query: any, req: any): Promise<{
        date: string;
        total: number;
        slaCompliant: number;
        complianceRate: number;
    }[]>;
    getAlertEscalationFlag(req: any): Promise<{
        escalate: boolean;
    }>;
    getEnhancedRecommendations(req: any): Promise<{
        tips: string[];
        forecast: {
            slope: number;
            intercept: number;
    ...
    getCourrierVolume(req: any): Promise<{
    ...
    getCourrierSlaBreaches(req: any): Promise<{
        pending: {
            id: string;
            createdAt: Date;
            updatedAt: Date;
    ...
    getCourrierRecurrence(req: any): Promise<{
    ...
    getCourrierEscalations(req: any): Promise<{
    ...
    getDailyKpis(query: AnalyticsKpiDto, req: any): Promise<{
    ...
    getPerformanceByUser(query: AnalyticsPerformanceDto, req: any): Promise<{
    ...
    getTrends(period: 'day' | 'week' | 'month', req: any): Promise<{
        date: Date;
        count: number;
    }[]>;
    ...
    getStaffing(req: any): Promise<{
        neededStaff: number;
        recommendation: string;
    }>;
    getThroughputGap(req: any): Promise<{
        planned: number;
        actual: number;
        gap: number;
    }>;
    exportAnalytics(query: AnalyticsExportDto, req: any): Promise<{
        filePath: string;
    }>;
    getTraceability(bordereauId: string, req: any): Promise<({
        documents: {
            id: string;
            name: string;
            bordereauId: string | null;
